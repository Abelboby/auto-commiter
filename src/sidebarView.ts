...
import { UpdateCheckResult } from "./updater";
...
type SidebarUpdateStatus = UpdateCheckResult["status"] | "installing";
...
export class AutoCommiterSidebarProvider implements vscode.WebviewViewProvider {
  ...
  setUpdateState(update: UpdateCheckResult): void {
    this.state.update = {
  ...
  setUpdateInstalling(update: UpdateCheckResult): void {
    this.state.update = {
      status: "installing",
